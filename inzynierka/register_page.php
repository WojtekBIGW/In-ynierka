                ...
                <div class="card bg-dark text-white shadow-lg" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <div class="mb-md-5 mt-md-4 pb-7">
                            <h2 class="mb-5 text-uppercase">Rejestracja</h2>
                            <div class="form-outline form-white mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="imie" class="form-control form-control-lg"
                            ...
                            <div class="form-outline form-white mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nazwisko" class="form-control form-control-lg"
