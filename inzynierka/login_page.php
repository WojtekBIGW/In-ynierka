                ...
                <div class="card bg-dark text-white shadow-lg" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <div class="mb-md-5 mt-md-4 pb-7">
                            <h2 class="mb-5 text-uppercase">Zaloguj się</h2>
                        ...
                        <div class="form-outline form-white mb-4">
                            <div class="input-group">
                                ...
                                <input type="password" id="typePasswordX" class="form-control form-control-lg" placeholder="Hasło" required/>
                            </div>
                        </div>
                        <p class="mb-4 pb-lg-2"><a class="text-white-50" href="#!">Zapomniałeś hasła?</a></p>
                        <button class="btn btn-outline-light btn-lg px-5" type="submit">Zaloguj się</button>
                    </div>
                    <div class="text-center">
                        <p class="mb-5">Nie masz konta? <a href="register_page.php" class="text-white-50 fw-bold">Zarejestruj się</a></p>
                    </div>
                </div>
            </div>
        </div>
